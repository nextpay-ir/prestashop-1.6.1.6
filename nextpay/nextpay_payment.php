...
class Nextpay_Payment
{
    ...
    public $lang = LanguageNX::Persian;
    ...
    {
        $l = $this->lang;
        if($l != 0 && $l != 1){$this->setLanguageNX(LanguageNX::Persian);}
     ...
     * @param int $lang
     */
    public function setLanguageNX($lang)
    {
        switch ($lang){
            case 0:
            case LanguageNX::English:
                $this->lang = LanguageNX::English;
                break;
            case 1:
            case LanguageNX::Persian:
                $this->lang = LanguageNX::Persian;
                break;
            default:
                $this->lang = LanguageNX::Persian;
        }
